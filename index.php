            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <?php if ($_SESSION['role'] == 'admin') { ?>
               ...
               <li class="nav-item">
                  ...
                  <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="index.php?page=daftar" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Pendaftaran</p>
                      </a>
                    </li>
                    ...
                    <li class="nav-item">
                      <a href="index.php?page=hasil_konsultasi" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Konsultasi</p>
                      </a>
                    </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="index.php?page=proses_daftar" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Daftar konsultasi</p>
                      </a>
                    </li>
                    <li class="nav-item">
                      <a href="index.php?page=konsultasi_pasien" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Konsultasi</p>
                      </a>
                    </li>
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                      <a href="index.php?page=konsultasi_dokter" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Konsultasi</p>
                      </a>
                    </li>
